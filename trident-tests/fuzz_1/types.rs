...
pub mod solana_stablecoin_standard {
    ...
    impl UpdateSupplyCapInstructionAccounts {
        pub fn new(authority: Pubkey, stablecoin: Pubkey, supply_cap: Pubkey) -> Self {
            Self {
                authority,
    ...
    impl UpdateSupplyCapInstruction {
        ...
        pub fn accounts(mut self, accounts: UpdateSupplyCapInstructionAccounts) -> Self {
            ...
            self.accounts.supply_cap = AccountMeta::new(accounts.supply_cap, false);
...
impl SupplyCap {
    pub fn new(cap: u64, bump: u8) -> Self {
        Self { cap, bump }
    }
}

/// Custom struct: SupplyCapUpdated
#[derive(Debug, BorshDeserialize, BorshSerialize, Clone)]
...
impl SupplyCapUpdated {
    pub fn new(stablecoin: Pubkey, new_cap: u64, updated_by: Pubkey, timestamp: i64) -> Self {
        Self {
            stablecoin,
